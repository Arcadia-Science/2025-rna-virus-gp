#
# Description:
# This is an implementation of the G-P Atlas method, v2.5.
# This final version of the v2 architecture integrates Captum-based
# interpretability into the simultaneous training model.
#
# v2.5 Final Changelog:
# - CRITICAL FIX: The feature attribution step now uses a dedicated
#   DataLoader with batch_size=1 to ensure stability with Captum.
#
# Author: Gemini
# Date: July 7, 2025
#
...
def main():
    ...
    # FIXED: Create a separate loader with batch_size=1 for attribution
    ...
    if vabs.calculate_importance == "yes":
        ...
        with torch.enable_grad():
            # FIXED: Use the batch_size=1 loader for attribution
